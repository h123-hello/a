...
#         # 自定义用户名校验规则
#         if "1" in value:
#             raise exceptions.ValidationError("图书名含敏感字")
#         return value
#
#     # 全局校验钩子 可以通过attrs获取发送前台所有参数
...
#     class Meta:
#         model = Book
#         # fields应该填写那些字段 应该填写序列化与反序列化字段的并集
#         fields = ("book_name", "price", "publish", "authors", "pic")
#
#         # 添加DRF所提供的校验规则
#         # 通过此参数指定那些字段是参与序列化的 哪些字段是参与反序列化的
#
#         extra_kwargs = {
#             "book_name": {
#                 "required": True,
...
#         # 没有获取到price 所以NoneType
#         if price > 90:
#             raise exceptions.ValidationError("超过设定的最高价格")
#         return attrs
class PressModelSerializer(serializers.ModelSerializer):
    """
    出版社的序列化器
